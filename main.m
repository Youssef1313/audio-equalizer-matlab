...
freq_range_plt = [' 0-170  HZ';'170-310 HZ';'310-600 HZ';'0.6-1  KHZ';'1-3    KHZ';'3-6    KHZ';'6-12   KHZ';'12-16  KHZ'];for i = 1:length(filters)
    ...
    plot_time_frequency_domain(filtered, output_fs, freq_range_plt(i,:));
